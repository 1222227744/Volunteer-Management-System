...
SET @admin_gbk_mojibake := CONVERT(CAST(@admin_name AS BINARY) USING gbk);
SET @organizer_gbk_mojibake := CONVERT(CAST(@organizer_name AS BINARY) USING gbk);

UPDATE users
SET display_name = @admin_name
WHERE username IN ('admin', 'admin@example.com')
  AND display_name IN (@admin_mojibake, @admin_gbk_mojibake);

UPDATE users
SET display_name = @organizer_name
WHERE username IN ('organizer', 'organizer@example.com')
  AND display_name IN (@organizer_mojibake, @organizer_gbk_mojibake);
...
SET updated_by_name = CASE updated_by_name
    ...
    WHEN @admin_gbk_mojibake THEN @admin_name
    WHEN @organizer_gbk_mojibake THEN @organizer_name
    ELSE updated_by_name
END
WHERE updated_by_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
...
END
WHERE created_by_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
...
SET operator_name = CASE operator_name
    ...
    ELSE operator_name
END
WHERE operator_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
...
END
WHERE corrected_by_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
...
END
WHERE requester_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake)
   OR reviewed_by_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
...
SET uploader_name = CASE uploader_name
    ...
    ELSE uploader_name
END
WHERE uploader_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
...
SET donor_name = CASE donor_name
    ...
    ELSE donor_name
END
WHERE donor_name IN (@admin_mojibake, @organizer_mojibake, @admin_gbk_mojibake, @organizer_gbk_mojibake);
